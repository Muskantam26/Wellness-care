    ...
    <div className="w-full bg-transparent py-10 px-4">
      ...
      <footer
        className="
          ...
          px-5 sm:px-10 md:px-12.5 lg:px-20
          pt-10 lg:pt-15
          pb-5
          text-[#4b5563]
          shadow-[0px_25.51px_107.13px_rgba(73,118,231,0.2)]
        "
      >
        {/* TOP SECTION */}
        <div className="flex flex-col lg:flex-row justify-between gap-10 mb-10">
          ...
          <div className="max-w-full lg:max-w-105 text-center lg:text-left flex flex-col items-center lg:items-start">
            <img
              src="src/Images/e680bf3cc74543e41f37479c54ba51c5243f0826.jpg"
              alt="Wellness Plus"
              className="w-50 lg:w-70 h-auto mb-4"
            />
          ...
          {/* LINKS - Grid on mobile/tablet, flex on desktop */}
          <div className="flex-3 grid grid-cols-2 md:grid-cols-3 gap-10 lg:flex lg:justify-evenly">

            <div className="col-span-1">
              <h3 className="text-[16px] lg:text-[18px] font-semibold text-[#1a1a1a] mb-5">
                Company
              </h3>
          ...
          <div className="flex-[1.2] text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <p className="text-[10px] text-[#253D4E] mb-4">
              From App Store or Google Play
            </p>

            <div className="flex gap-3 mb-8">
              <img
                src="src/Images/dc4b2ffca1101b9deff29af3a785dfba02788877.jpg"
                className="w-23.75 h-auto cursor-pointer"
                alt="App Store"
              />
              <img
                src="src/Images/7844144b561e00edee01e736c431c7d8af4eb2f0.jpg"
                className="w-23.75 h-auto cursor-pointer"
                alt="Google Play"
              />
            </div>

            <p className="text-[14px] font-black text-[#253D4E] mb-3 font-['Lato']">
              Secured Payment Gateways
            </p>

            <img
              src="src/Images/abfde2069df20d065d424eb84b76f8b62e604c51.png"
