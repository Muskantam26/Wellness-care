    ...
    <div className="px-6 py-12 lg:px-50 lg:py-25 overflow-y-auto overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-15">
        ...
        <div className="flex-[1.2]">
          <p className="flex items-center gap-2 font-semibold relative lg:-left-2.5">
            <img src="src/Images/leaf.svg fill.png" alt="" className="w-7" />
      ...
      <div className="relative flex justify-center lg:justify-start lg:left-120 lg:top-5 items-center group mt-16 lg:mt-10">
        ...
        <img
              ...
              />
              <button className="bg-[#FBDF7E] text-[#2d3748] px-10 md:px-12.5 py-2.75 md:py-3.25 rounded-xl border-none cursor-pointer">
      ...
      <div className="flex flex-col lg:flex-row gap-20 lg:gap-5 mt-25 lg:mt-7.5 items-center">
        ...
        {/* FIRST CARD */}
       <div
  className="border border-[#768653] rounded-[20px] h-100 w-full max-w-103.25 relative"
  data-aos="zoom-in"
>

          <div className="relative">
            <img src="src/Images/ourimg.png" alt="" className="relative -top-15 -left-3.75" />
            <img src="src/Images/ourimg.png" alt="" className="absolute -top-27.5 -left-6.75" />
          </div>
          ...
          relative -top-62.5 ml-37.5 lg:ml-47.5 pr-4 text-justify lg:-left-3.75">
            ...
            Shelves full of chemicals made us question what we were truly consuming.
          </span>
        </div>

        {/* SECOND CARD */}
        <div
  className="border border-[#768653] rounded-[20px] h-87.5 w-full max-w-103.25 mt-20 lg:mt-25 relative"
  data-aos="zoom-in"
  data-aos-delay="150"
>

          <div className="relative">
            <img src="src/Images/l2.png" alt="" className="relative -top-22.5 rotate-[-60deg] w-full lg:w-100 h-72.5" />
            <img src="src/Images/l2.png" alt="" className="absolute -top-35 -left-3 rotate-[-60deg] w-full lg:w-100 h-72.5" />
          </div>
          <h1 className="text-[60px] lg:text-[70px] font-semibold relative -top-37.5 left-5">The</h1>
          <p className="text-[21px] font-medium relative -top-42.5 left-5">Mission</p>
          <span className="block text-[12px] leading-5.75 font-medium text-[#4E4E4E]
          relative -top-50 ml-37.5 lg:ml-47.5 pr-4 text-justify lg:-left-3.75">
            We turned to our roots. To farmers. To traditional grains. To methods that respect
            the soil and nourish the body.
          </span>
        </div>

        {/* THIRD CARD */}
       <div
  className="border border-[#768653] rounded-[20px] h-100 w-full max-w-103.25 relative mt-20 lg:mt-0"
  data-aos="zoom-in"
  data-aos-delay="300"
>

          <img src="src/Images/three.png" alt="" className="relative left-10 lg:left-17.5 -top-25" />
          <h1 className="text-[60px] lg:text-[70px] font-semibold relative -top-37.5 left-5">The</h1>
          <p className="text-[21px] font-medium relative -top-42.5 left-5">Craft</p>
          <span className="block text-[12px] leading-5.75 font-medium text-[#4E4E4E]
          relative -top-62.5 ml-37.5 lg:ml-47.5 pr-4 text-justify lg:-left-3.75">
            Every batch is made with attention, patience, and purpose. We don’t rush.
            We don’t compromise. We create food the way it was meant to be.
          </span>
        </div>
